...
function UserManagement({ user, onLogout }) {
    const [users, setUsers] = useState([
        { id: '1', name: 'Admin User', email: 'admin@demo.com', role: 'admin', status: 'active', lastLogin: new Date().toISOString() },
        { id: '2', name: 'Basic User', email: 'user@demo.com', role: 'user', status: 'active', lastLogin: new Date(Date.now() - 86400000).toISOString() },
        { id: '3', name: 'John Doe', email: 'john@demo.com', role: 'user', status: 'active', lastLogin: new Date(Date.now() - 172800000).toISOString() },
        { id: '4', name: 'Jane Smith', email: 'jane@demo.com', role: 'admin', status: 'inactive', lastLogin: new Date(Date.now() - 604800000).toISOString() },
    ]);
